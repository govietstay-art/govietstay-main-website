...
title GoVietStay Universal Partner Kit V4.1 FIX3 - Smart Background Switcher
...
> "%LOG%" echo GoVietStay Universal Partner Kit V4.1 FIX3
>>"%LOG%" echo Smart Background Switcher + Mobile First
>>"%LOG%" echo Started: %date% %time%
>>"%LOG%" echo.

echo ============================================================
echo GoVietStay Universal Partner Kit V4.1 FIX3
...
echo [2/5] FIX3 preflight + applying V4.1 patch safely...
set "GVS_SELF=%~f0"
