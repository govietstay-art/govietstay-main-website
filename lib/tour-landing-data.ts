...
export type TourLanding = {
  ...
  addOns?: { id: string; title: string; price: number; description: string; notes: string[] }[];
};
...
const ru: Record<string, TourLanding> = {
  ...
  "cham-island": {
    ...
    faqs: [
      ...
      { question: "Можно добавить Sea Walk или дайвинг в день поездки?", answer: "Не рассчитывайте на бронирование в последний момент. Sea Walk и дайвинг имеют ограниченное количество мест и требуют предварительного подтверждения. Сообщите выбранную активность, дату, возраст участников и важную медицинскую информацию до оплаты." },
    ],
    reviews: [
      {
        name: "Наталья",
    ...
    addOns: [
      {
        id: "sea-walk",
        title: "Sea Walk — прогулка под водой в шлеме",
        price: 900000,
        description: "Прогулка по морскому дну в специальном шлеме с сопровождением команды оператора. Навыки дайвинга обычно не требуются.",
        notes: ["Добавляется к стоимости стандартной экскурсии", "Требуется предварительное бронирование", "Количество мест очень ограничено", "Участник заполняет анкету о состоянии здоровья"],
      },
      {
        id: "scuba",
        title: "Дайвинг с аквалангом и инструктором",
        price: 900000,
        description: "Погружение с баллоном в сопровождении инструктора после обязательного инструктажа и проверки возможности участия.",
        notes: ["Добавляется к стоимости стандартной экскурсии", "Требуется предварительное бронирование", "Количество мест очень ограничено", "Допуск зависит от здоровья, погоды и решения инструктора"],
      },
    ],
  },
};
