...
chcp 65001 >nul
title GoVietStay - Phu Quoc Vietnamese Text Fix V6
...
echo.
echo ================================================================
echo  GOVIETSTAY - PHU QUOC VIETNAMESE TEXT FIX V6
echo ================================================================
echo.
echo  V6 sua loi PowerShell parse + chu bi vo font:
echo   - Ghi file PowerShell bang UTF-16LE BOM de Windows PowerShell doc dung Unicode
echo   - Chi sua cac dong Partner Master bi sai encoding
echo   - Khong dung vao booking / QR / poster / commission / Partner Master logic
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$b=(Get-Content -Raw -LiteralPath '%B64%') -replace '\s',''; $u8=[Text.Encoding]::UTF8.GetString([Convert]::FromBase64String($b)); [IO.File]::WriteAllText('%PS1%',$u8,[Text.Encoding]::Unicode)"
if errorlevel 1 goto FAIL_WORKTREE
