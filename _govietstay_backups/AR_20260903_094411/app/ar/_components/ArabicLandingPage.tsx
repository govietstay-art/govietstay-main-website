    ...
    <main className={`subpage subpage-${props.accent}`}>
      <header className="site-header subpage-header">
        <Link className="brand" href="/ar" aria-label="GoVietStay العربية">
          <Image src="/ar-assets/logo.png" alt="شعار GoVietStay الرسمي" width={56} height={56} priority />
      ...
      <footer>
        <Link className="brand footer-brand" href="/ar"><Image src="/ar-assets/logo.png" alt="GoVietStay" width={56} height={56} /><span><b>GoVietStay</b><small>Trusted Local Support</small></span></Link>
