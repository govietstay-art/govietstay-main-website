...
const destinations = [
  {
    ...
    image: "/ar-assets/hero-hoian.jpg",
    position: "center",
  },
  {
    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="GoVietStay الرئيسية">
          <Image src="/ar-assets/logo.png" alt="شعار GoVietStay الرسمي" width={58} height={58} priority />
      ...
      <footer>
        <div className="brand footer-brand"><Image src="/ar-assets/logo.png" alt="GoVietStay" width={56} height={56} /><span><b>GoVietStay</b><small>Trusted Local Support</small></span></div>
