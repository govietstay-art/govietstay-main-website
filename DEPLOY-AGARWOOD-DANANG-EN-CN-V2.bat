...
chcp 65001 >nul
title GoVietStay Agarwood Da Nang V2 - Deploy EN + CN

echo =============================================================
echo      GOVIETSTAY AGARWOOD DA NANG V2 - DEPLOY EN + CN
echo =============================================================
echo.
echo V2 dung ROBOCOPY de tranh loi copy cua ban V1.
echo.
echo Se tao:
...
set "PAYLOAD_ZIP=%INSTALLER_DIR%AGARWOOD-DANANG-PAYLOAD-V2.zip"
set "TARGET="
...
if not defined TARGET (
  ...
  echo   DEPLOY-AGARWOOD-DANANG-EN-CN-V2.bat
  echo   AGARWOOD-DANANG-PAYLOAD-V2.zip
  echo.
  pause
  exit /b 1
)
...
if not exist "%PAYLOAD_ZIP%" (
  echo [STOP] Thieu AGARWOOD-DANANG-PAYLOAD-V2.zip
  pause
  exit /b 1
)
...
set "TEMP_PAYLOAD=%TEMP%\GOVIETSTAY-AGARWOOD-V2-%STAMP%"
set "BACKUP=%TARGET%\BACKUP-AGARWOOD-DANANG-V2-%STAMP%"
...
robocopy "%TEMP_PAYLOAD%" "%TARGET%" /E /R:2 /W:1 /NFL /NDL /NJH /NJS /NP
set "RC=%ERRORLEVEL%"
...
echo.
echo =============================================================
echo             DEPLOY AGARWOOD V2 THANH CONG
echo =============================================================
echo.
echo English:
...
:payload_error
echo.
echo [LOI] Payload V2 khong hop le hoac giai nen that bai.
rmdir /s /q "%TEMP_PAYLOAD%" 2>nul
pause
exit /b 1
