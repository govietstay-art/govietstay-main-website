...
export default function WinkSpaPage() {
  return <main className={styles.page}>
    <header className={styles.header}>
      ...
      <nav><a href="#night-market">Night market</a><a href="#gallery">Real photos</a><a href="#services">Services</a><a href="#location">Map</a></nav>
    ...
    <section className={styles.hero} id="top">
      ...
      <div className={styles.heroMedia}><Image src="/partners/wink-spa-tuyet-massage-da-nang/wink-spa-hero.webp" alt="Actual Wink Spa – Tuyết Massage storefront photographed in Da Nang" width={1400} height={1050} unoptimized className={styles.storePhoto}/><div className={styles.mediaTag}>LOOK FOR THE WINK SPA SIGN · REAL SHOP PHOTO</div></div>
    </section>
    ...
    <section className={styles.photoGallery} id="gallery" aria-label="Real photographs of Wink Spa and Tuyết Massage">
      <div className={styles.photoHeading}>
        <p className={styles.eyebrow}>REAL PHOTOS OF WINK SPA - TUYET MASSAGE</p>
        <h2>See the real spa <em>before you visit.</em></h2>
        <p>Explore the actual storefront, seating, service menu and evening atmosphere at Wink Spa - Tuyết Massage near Son Tra Night Market.</p>
      </div>
      <div className={styles.photoGrid}>
        <figure className={styles.photoCard}><Image src="/partners/wink-spa-tuyet-massage-da-nang/wink-spa-hero.webp" alt="Wink Spa illuminated sign and storefront at night" fill sizes="(max-width: 850px) 100vw, 55vw" unoptimized /><figcaption>01 - Actual storefront</figcaption></figure>
        <figure className={styles.photoCard}><Image src="/partners/wink-spa-tuyet-massage-da-nang/wink-spa-night-market-front.webp" alt="Wide view of spa exterior and outdoor seats" fill sizes="(max-width: 850px) 100vw, 45vw" unoptimized /><figcaption>02 - Street view and outdoor seating</figcaption></figure>
        <figure className={styles.photoCard}><Image src="/partners/wink-spa-tuyet-massage-da-nang/wink-spa-interior.webp" alt="Reclining massage chairs inside Wink Spa" fill sizes="(max-width: 850px) 100vw, 33vw" unoptimized /><figcaption>03 - Indoor seating</figcaption></figure>
        <figure className={styles.photoCard}><Image src="/partners/wink-spa-tuyet-massage-da-nang/tuyet-massage-menu.webp" alt="Tuyết Massage outdoor service menu, with prices subject to confirmation" fill sizes="(max-width: 850px) 100vw, 33vw" unoptimized /><figcaption>04 - Service menu, confirm current prices</figcaption></figure>
        <figure className={styles.photoCard}><Image src="/partners/wink-spa-tuyet-massage-da-nang/wink-spa-busy-evening.webp" alt="Authentic evening view of guests inside the spa" fill sizes="(max-width: 850px) 100vw, 33vw" unoptimized /><figcaption>05 - Real evening atmosphere</figcaption></figure>
      </div>
    </section>
