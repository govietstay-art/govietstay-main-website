  ...
  return (
    <main>
      ...
      <section className="section cancellation-policy">
        ...
        <h2>Clear terms before you book</h2>
        <ul>
          <li>Cancellation at least 24 hours before departure is free of charge.</li>
          <li>Cancellation 12–24 hours before departure is charged at 50% of the total booking price.</li>
          <li>Cancellation less than 12 hours before departure, last-minute cancellation or no-show is charged at 100% of the total booking price.</li>
        </ul>
      </section>
