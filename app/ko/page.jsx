  ...
  return (
    <main className="koHub" lang="ko">
      ...
      <header className="navWrap">
        <a className="brand" href="/ko" aria-label="GoVietStay 한국어 홈">
      ...
      <footer className="footer">
        <div>
          <a className="brand footerBrand" href="/ko"><img src="/logo.png" alt="GoVietStay" /><span><b>GoVietStay</b><small>Trusted Local Support</small></span></a>
      ...
      <style>{`
        ...
        @media(max-width:980px){.desktopNav{display:none}.heroInner{grid-template-columns:1fr;gap:35px;padding-top:80px}.hero{min-height:780px}.hero h1{font-size:58px}.heroDeal{max-width:520px}.quickAnswers{grid-template-columns:1fr 1fr;margin-top:0}.quickAnswers div{border-right:1px solid var(--line);border-radius:0!important}.sectionHead{grid-template-columns:1fr}.serviceGrid{grid-template-columns:1fr 1fr}.realGrid{grid-template-columns:1fr}.guideGrid{grid-template-columns:1fr 1fr}.steps{grid-template-columns:1fr}.faqGrid{grid-template-columns:1fr}}
