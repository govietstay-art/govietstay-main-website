...
const tours: Tour[] = [
  ...
  {
    title: "Cham Island Speedboat Tour",
    image: "/tour/cham.jpg",
    duration: "07:30 – 15:30",
    category: "Cham Island • Speedboat • Snorkeling • Seafood Lunch",
    price: {
      adult: 950000,
      child: 800000,
      note: "Joined Cham Island speedboat tour. Includes hotel pickup and drop-off, English-speaking guide, round-trip speedboat, entrance tickets, snorkeling equipment, seafood lunch and drinking water.",
    },
    description:
      "Discover Cham Island by speedboat, visit Bai Lang Village, the Marine Museum, Hai Tang Pagoda and the Marine Protected Area, then enjoy snorkeling and seafood lunch at Bai Ong Beach.",
    overview:
      "A classic Cham Island day trip for travelers staying in Da Nang or Hoi An. The tour combines fast speedboat transfer from Cua Dai Pier, island sightseeing, snorkeling in clear water, seafood lunch at Bai Ong Beach and free time to swim or relax before returning to the mainland.",
    highlights: [
      "Round-trip speedboat transfer to Cham Island",
      "Visit Bai Lang Village, Marine Museum and Hai Tang Pagoda",
      "Marine Protected Area sightseeing",
      "Snorkeling in crystal-clear water with colorful coral reefs",
      "Seafood lunch at Bai Ong Beach",
      "Free time to relax, swim and enjoy the island atmosphere",
    ],
    itinerary: [
      "07:30 – 08:30: Hotel pickup and transfer to Cua Dai Pier.",
      "09:15: Depart by speedboat to Cham Island.",
      "09:40 – 10:30: Arrive at Cham Island. Visit Bai Lang Village, the Marine Museum, Hai Tang Pagoda and the Marine Protected Area.",
      "10:30 – 12:00: Enjoy snorkeling in crystal-clear waters and discover colorful coral reefs.",
      "12:00 – 14:00: Seafood lunch at Bai Ong Beach and free time to relax or swim.",
      "14:30 – 15:30: Return to the mainland and transfer back to your hotel. End of tour.",
    ],
    included: [
    ...
    notIncluded: ["Personal expenses", "Additional beverages"],
    childPolicy: [
      "Child price: 800,000 VND.",
      "Adult price applies according to operator height or age policy when required.",
      "Please share child age and height before booking for exact confirmation.",
    ],
    bestFor: [
      "Beach lovers",
      ...
      "Travelers who prefer a faster island transfer",
    ],
    localTips: [
      "Bring swimwear, towel, sunscreen, hat and a change of clothes.",
