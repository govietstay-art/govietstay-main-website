...
export default async function BookingPaymentPage({ params }: Props) {
  ...
  return (
    <main className="gvsPayWrap">
      ...
      `}</style>
      <div className="brand"><img src="/logo.png" alt="GoVietStay" /><span>Trusted Local Support â€¢ Vietnam</span></div>
      <article className="card">
        ...
        {active && <section className="section">
          ...
          {data.payment.paypal_url && <><div className="or">OR</div><a className="paypal" href={data.payment.paypal_url} target="_blank" rel="noopener noreferrer" aria-label="International payment by Visa or Mastercard"><span>International Payment&nbsp; â€¢ &nbsp;Visa / Mastercard</span></a></>}
