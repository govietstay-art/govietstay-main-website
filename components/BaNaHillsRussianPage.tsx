...
Я понимаю, что в Ba Na Hills может быть очень многолюдно и невозможно гарантировать количество посетителей, очереди, погоду, видимость и фактическую ситуацию. Пожалуйста, подтвердите наличие мест, трансфер, питание и точную стоимость до оплаты.`;
  ...
  return (
    <main>
      ...
      <section className="section cancellation-policy">
        <p className="label">Условия отмены</p>
        <h2>Понятные условия до бронирования</h2>
        <ul>
          <li>Отмена не позднее чем за 24 часа до отправления — бесплатно.</li>
          <li>При отмене за 12–24 часа до отправления взимается 50% полной стоимости бронирования.</li>
          <li>При отмене менее чем за 12 часов, отмене непосредственно перед отправлением или неявке взимается 100% полной стоимости бронирования.</li>
        </ul>
      </section>
