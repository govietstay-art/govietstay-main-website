...
title GoVietStay Universal Partner Kit V4.1 FIX2 - Smart Background Switcher
...
> "%LOG%" echo GoVietStay Universal Partner Kit V4.1 FIX2
>>"%LOG%" echo Smart Background Switcher + Mobile First
>>"%LOG%" echo Started: %date% %time%
>>"%LOG%" echo.

echo ============================================================
echo GoVietStay Universal Partner Kit V4.1 FIX2
...
if (!$src.Contains("Universal Partner Kit V4")) {
    throw "Expected Universal Partner Kit V4 source was not found. Stop to avoid patching the wrong version."
}
